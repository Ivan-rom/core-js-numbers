...
function getAverage(value1, value2) {
  ...
  if (average === Infinity) return Number.MAX_VALUE;
  if (average === -Infinity) return Number.MIN_VALUE;
  return average;
}
...
function toNumber(value, def) {
  ...
  if (Number.isNaN(newNum)) return def;
  return newNum;
}
